              ...
              <div className="col-span-full">
                ...
                <div className="flex items-center space-x-2">
                  <img
                    ...
                    alt=""
                    className="w-10 h-10 bg-gray-500 dark:bg-gray-500 rounded-full bg-gray-700 dark:bg-gray-300"
                  />
                  <button
                    type="button"
                    className="px-4 py-2 border rounded-md border-gray-100 dark:border-gray-800"
                  >
                    Change
                  </button>
                </div>
